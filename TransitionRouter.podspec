#
# Be sure to run `pod lib lint TransitionRouter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TransitionRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'TransitionRouter/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TransitionRouter' => ['TransitionRouter/Assets/*.png']
  # }
